...
data("mlt_rg_sable_mod_results") # load in model results and rename
sabie_rtmb_model <- mlt_rg_sable_mod_results
```
...
```{r, fig.width = 12, fig.height = 5.5, message = FALSE, warning = FALSE}
