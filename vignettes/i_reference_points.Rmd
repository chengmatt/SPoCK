...
\[
SSB^{fished} = \sum_a N_{a}^{\text{fished}} \cdot W_{y=1,a,s=1} \cdot Mat_{y=1,a,s=1} \cdot \exp(-t_{spwn} \cdot M_{y=1,a,s=1} + \sum_f \text{Frat}_f \cdot F_x \cdot \text{Sel}_{y=\text{term},a-1,s=1,f}^{\text{Fsh}}) \\ 
SSB^{unfished} = \sum_a N_{a}^{\text{unfished}} \cdot W_{y=1,a,s=1} \cdot Mat_{y=1,a,s=1} \cdot \exp(-t_{spwn} \cdot M_{y=1,a,s=1})
\]
