...
input_list <- Setup_Mod_Biologicals(
    ...
    # Data inputs
    WAA = ebswp_SPoCK_data$WAA,
    MatAA = ebswp_SPoCK_data$MatAA,
    AgeingError = ebswp_SPoCK_data$AgeingError,
    # ageing error
...
input_list <- Setup_Mod_Catch_and_F(
  ...
  # Data inputs
  ObsCatch = ebswp_SPoCK_data$ObsCatch,
  Catch_Type = ebswp_SPoCK_data$Catch_Type,
  UseCatch = ebswp_SPoCK_data$UseCatch,
...
input_list <- Setup_Mod_FishIdx_and_Comps(
  ...
  # data inputs
  ObsFishIdx = array(NA, dim = c(1, length(yrs), 1)),
  ObsFishIdx_SE = array(NA, dim = c(1, length(yrs), 1)),
  UseFishIdx = array(0, dim = c(1, length(yrs), 1)),
  ObsFishAgeComps = ebswp_SPoCK_data$ObsFishAgeComps,
  UseFishAgeComps = ebswp_SPoCK_data$UseFishAgeComps,
  ISS_FishAgeComps = ebswp_SPoCK_data$ISS_FishAgeComps,
...
input_list <- Setup_Mod_SrvIdx_and_Comps(
    ...
    # data inputs
    ObsSrvIdx = ebswp_SPoCK_data$ObsSrvIdx,
    ObsSrvIdx_SE = ebswp_SPoCK_data$ObsSrvIdx_SE,
    UseSrvIdx = ebswp_SPoCK_data$UseSrvIdx,
    ObsSrvAgeComps = ebswp_SPoCK_data$ObsSrvAgeComps,
    ISS_SrvAgeComps = ebswp_SPoCK_data$ISS_SrvAgeComps,
    UseSrvAgeComps = ebswp_SPoCK_data$UseSrvAgeComps,
...
data("sgl_rg_ebswp_mod_results") # load in model results and rename
ebswp_rtmb_model <- sgl_rg_ebswp_mod_results
```
