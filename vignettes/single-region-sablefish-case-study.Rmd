...
input_list <- SPoCK:: Setup_Mod_Rec(input_list = input_list, # input data list from above
                            # Model options
...
input_list <- SPoCK::Setup_Mod_Biologicals(input_list = input_list,
                                    
                                    # Data inputs
                                    WAA = rtmb_data$WAA, 
                                    # weight-at-age
                                    MatAA = rtmb_data$MatAA, 
                                    # maturity at age
                                    AgeingError = as.matrix(ageing_dat$age_error),
                                    # ageing error
                                    SizeAgeTrans = rtmb_data$SizeAgeTrans, 
...
input_list <- SPoCK::Setup_Mod_Catch_and_F(input_list = input_list,
                                    # Data inputs
...
input_list <- SPoCK::Setup_Mod_SrvIdx_and_Comps(input_list = input_list,
                                         # data inputs
...
input_list <- SPoCK::Setup_Mod_Fishsel_and_Q(input_list = input_list,
...
input_list <- SPoCK::Setup_Mod_Srvsel_and_Q(input_list = input_list,
...
input_list$par$ln_srv_fixed_sel_pars[1,,,1,3] <- 
  c(0.980660760456, tem_par$coefficients[names(tem_par$coefficients) == "log_delta_srv1_f"])
input_list$par$ln_srv_fixed_sel_pars[1,,,2,3] <- 
  c(1.22224502478, tem_par$coefficients[names(tem_par$coefficients) == "log_delta_srv1_m"])
```
...
input_list <- SPoCK::Setup_Mod_Weighting(input_list = input_list,
                                  sablefish_ADMB = 1,
                                  likelihoods = 0,
                                  Wt_Catch = 50,
                                  Wt_FishIdx = 0.448,
