...
input_list <- Setup_Mod_Dim(years = 1:65, # vector of years 
...
data("sgl_rg_sable_mod_results") # load in model results and rename
sabie_rtmb_model <- sgl_rg_sable_mod_results
```
...
```{r Compare Models, message = FALSE, eval = TRUE, fig.width = 11, fig.height = 5, fig.align='center'}
