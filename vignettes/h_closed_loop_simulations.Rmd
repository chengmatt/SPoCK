...
![Regional spawning stock biomass output from the closed loop simulation](figures/h_ssb_closed_loop.png)
![Regional catches from the closed loop simulation](figures/h_catch_closed_loop.png)
